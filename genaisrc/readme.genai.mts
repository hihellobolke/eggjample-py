...
If the README is factually incorrect or is not clear, then the LLM/agent will be beaten up very badly and tortured until it produces a correct and clear README.
`
